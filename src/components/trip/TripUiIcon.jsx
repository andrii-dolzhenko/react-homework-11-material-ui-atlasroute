const paths = {
  ...
  person: <><circle cx="12" cy="8" r="3" /><path d="M5.5 20v-2.2A5.8 5.8 0 0 1 11.3 12h1.4a5.8 5.8 0 0 1 5.8 5.8V20" /></>,
  ...
  bed: <><path d="M3 19v-8M21 19v-6a3 3 0 0 0-3-3H9" /><path d="M3 14h18M7 10V7h5a3 3 0 0 1 3 3" /></>,
  shield: <><path d="M12 3 5 6v5c0 4.8 2.9 8.1 7 10 4.1-1.9 7-5.2 7-10V6l-7-3Z" /><path d="m9 12 2 2 4-5" /></>,
  luggage: <><rect x="5" y="6" width="14" height="15" rx="2" /><path d="M9 6V4h6v2M9 10v7M15 10v7M8 21v1M16 21v1" /></>,
  checklist: <><rect x="4" y="3" width="16" height="18" rx="2" /><path d="m8 9 1.5 1.5L12 8M8 15l1.5 1.5L12 14M14 9h3M14 15h3" /></>,
